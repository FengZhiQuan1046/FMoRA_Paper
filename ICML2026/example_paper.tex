...
\begin{align}
    \Delta \mW & = \mU\mV + \mathcal{F}(\mU\mV, \mA, \mB) \\
    \mathcal{F}(\mU\mV, \mA, \mB) & = \frac{1}{D_1D_2}\sum_{j=1}^{D_1} \frac{\mA}{j}e^{2\pi i \cdot jUV} \cdot \sum_{k=1}^{D_2} \frac{\mB}{k}e^{2\pi i \cdot kUV} \notag
\end{align}
...
\appendix
\onecolumn
\section{Gradient Jacobian Analysis}
...
\section{Gradient Upperbound Analysis}

\section{Gradient Variance Analysis}
